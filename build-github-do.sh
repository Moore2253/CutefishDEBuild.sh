...
function Compile(){
    case $1 in 
        ...
        cd ~/cutefishos
        echo '正在克隆项目'
        git clone https://github.do/https://github.com/cutefishos/filemanager.git
        echo '正在编译'
        ...
        cd ~/cutefishos
        echo '正在克隆项目'
        git clone https://github.do/https://github.com/cutefishos/dock.git
        echo '正在编译'
        cd ~/cutefishos/dock
        sudo mk-build-deps ./debian/control -i -t "apt-get --yes" -r
        dpkg-buildpackage -b -uc -us
        ...
        fishui)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/fishui.git
        ...
        screenshot)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/screenshot.git
        ...
        qt-plugins)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/qt-plugins.git
        ...
        terminal)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/terminal.git
        ...
        launcher)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/launcher.git
        ...
        settings)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/settings.git
        ...
        debinstaller)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/debinstaller.git
        ...
        icons)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/icons.git
        cd ~/cutefishos/icons
        sudo mk-build-deps ./debian/control -i -t "apt-get --yes" -r
        dpkg-buildpackage -b -uc -us
        mkdir build
        ...
        gtk-themes)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/gtk-themes.git
        ...
        daemon)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/daemon.git
        ...
        statusbar)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/statusbar.git
        ...
        libcutefish)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/libcutefish.git
        ...
        core)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/core.git
        cd ~/cutefishos/core
        sudo mk-build-deps ./debian/control -i -t "apt-get --yes" -r
        dpkg-buildpackage -b -uc -us
        mkdir build
        ...
        updator)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/updator.git
        ...
        screenlocker)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/screenlocker.git
        ...
        git clone https://github.do/https://github.com/cutefishos/texteditor.git
        ...
        calculator)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/calculator.git
        ...
        kwin-plugins)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/kwin-plugins.git
        ...
        videoplayer)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/videoplayer.git
        ...
        sddm-theme)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/sddm-theme.git
        ...
        appmotor)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/appmotor.git
        ...
        wallpapers)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/wallpapers.git
        ...
        calamares)
        cd ~/cutefishos
        git clone https://github.do/https://github.com/cutefishos/calamares.git
